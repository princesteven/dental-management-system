...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
        <section class="panel col-md-12 row">
            ...
            <div class="panel-body">
                ...
                <form role="form" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label"> 
                            <label for="exampleInputEmail1"> <?php echo lang('appointment'); ?> <?php echo 'Type'; ?></label>
                        </div>
                        <div class="col-md-9"> 
                            <select class="form-control m-bot15" name="type" value=''>
                                ...
                                ?> > <?php echo 'Procedure'; ?> </option> 
                                <option value="X ray" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'X ray') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo'X ray'; ?> </option>
                                <option value="OPG" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'OPG') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'OPG'; ?> </option>
                                <option value="free_consultation" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'free_consultation') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Free Consultation'; ?> </option>
                                <option value="free_consultation" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'free_consultation') {
                                        echo 'selected';
                                ...
                                ?> > <?php echo 'Consultation'; ?> </option>

                                <option value="check_up" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'check_up') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Check up'; ?> </option>

                                <option value="executive_check_up" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'executive_check_up') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Executive Check up'; ?> </option>

                                <option value="continuation" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'continuation') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Continuation'; ?> </option>

                                <option value="root_canal_continuation" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'root_canal_continuation') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Rootcanal Continuation'; ?> </option>

                                <option value="outreach" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'outreach') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Outreach'; ?> </option>

                                <option value="social_media_winners" <?php
                                if (!empty($appointment->type)) {
                                    if ($appointment->type == 'social_media_winners') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Social Media Winners'; ?> </option>
                     ...
                     <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label"> 
                            <label for="exampleInputEmail1"> <?php echo 'Is New Patient'; ?></label>
                        </div>
                        <div class="col-md-9"> 
                            <select class="form-control m-bot15" required="" name="is_new_patient" value=''>
                               <?php if (empty($appointment->is_new_patient)) {?>
                                <option value="">select..</option>
                            <?php }?>
                                <option value="Yes" <?php
                                if (!empty($appointment->is_new_patient)) {
                                    if ($appointment->is_new_patient == 'Yes') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'Yes'; ?> </option> 
                                    ...
                                    <option value="No" <?php
                                if (!empty($appointment->is_new_patient)) {
                                    if ($appointment->is_new_patient == 'No') {
                                        echo 'selected';
                                    }
                                }
                                ?> > <?php echo 'No'; ?> </option> 
                    ...
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label"> 
                            <label class=""><?php echo '* VITALS'; ?></label><br>
                        </div>
                        <div class="col-md-9"> 
                          <br> <label class=""><?php echo 'Height'; ?></label><input type="text" class="form-control" name="height" id="" value='<?php
                                if (!empty($appointment->height)) {
                                    echo $appointment->height;
                                }
                                ?>'><br>

                             <label class=""><?php echo 'Weight'; ?></label><input type="text" class="form-control" name="weight" id="" value='<?php
                                if (!empty($appointment->weight)) {
                                    echo $appointment->weight;
                                }
                                ?>'><br>  

                              <label class=""><?php echo 'Temperature'; ?></label><input type="text" class="form-control" name="temperature" id="" value='<?php
                                if (!empty($appointment->temperature)) {
                                    echo $appointment->temperature;
                                }
                                ?>'><br>  

                              <label class=""><?php echo 'BP'; ?></label><input type="text" class="form-control" name="bp" id="" value='<?php
                                if (!empty($appointment->bp)) {
                                    echo $appointment->bp;
                                }
                                ?>'><br>  
