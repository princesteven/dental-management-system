                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        foreach ($holidays as $holiday) {
                            ...
                            <tr class="">
                                ...
                                <td> <?php echo date('d-m-Y', $holiday->start_date); ?></td> 
                                <td> <?php echo date('d-m-Y', $holiday->end_date); ?></td> 
                                <?php if ($this->ion_auth->in_group(array('admin', 'Doctor'))) { ?>
                                    <td>
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addHoliday" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6 pull-right">
                        <label for="exampleInputEmail1"> <?php echo lang('start'); ?> <?php echo lang('date'); ?></label>
                        <input type="text" class="form-control default-date-picker" name="start_date" id="exampleInputEmail1" value='' readonly="">
                    </div>

                    <div class="form-group col-md-6 pull-right">
                        <label for="exampleInputEmail1"> <?php echo lang('end'); ?> <?php echo lang('date'); ?></label>
                        <input type="text" class="form-control default-date-picker" name="end_date" id="exampleInputEmail1" value='' readonly="">
                    </div>
                                    ...
                                    $(document).ready(function () {
                                        $(".editbutton").click(function (e) {
                                            ...
                                            $.ajax({
                                                ...
                                                var start_date = new Date(response.holiday.start_date * 1000);
                                                var end_date = new Date(response.holiday.end_date * 1000);
                                                ...
                                                $('#editHolidayForm').find('[name="start_date"]').val(start_date.getDate() + '-' + (start_date.getMonth() + 1) + '-' + start_date.getFullYear()).end()
                                                $('#editHolidayForm').find('[name="end_date"]').val(end_date.getDate() + '-' + (end_date.getMonth() + 1) + '-' + end_date.getFullYear()).end()
                                            });
                                        });
                                    });
</script>
