...
// Validating Week Day Field   
    ...
    function addHoliday() {
        ...
        if (empty($id)) {
            $is_exist = $this->schedule_model->getHolidayByDoctorByDate($doctor, $start_date, $end_date);
            if (!empty($is_exist)) {
            ...
            $is_exist = $this->schedule_model->getHolidayByDoctorByDateById($doctor, $start_date, $end_date, $id);
            if (!empty($is_exist)) {
                $this->session->set_flashdata('feedback', 'Already Exists !');
                redirect($redirect);
                die();
...
// Validating Dates Fields
        $this->form_validation->set_rules('start_date', 'Date', 'trim|required|min_length[5]|max_length[100]|xss_clean');
        $this->form_validation->set_rules('end_date', 'Date', 'trim|required|min_length[5]|max_length[100]|xss_clean');
