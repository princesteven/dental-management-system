                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-samples">
                        <thead>
                            <tr>
                                ...
                                <th class=""><?php echo lang('card'); ?> <?php echo lang('number'); ?></th>
                               <!--  <th class=""><?php echo 'Procedure'; ?></th>
                                ...
                                if ($payment->date == $value) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td><?php echo $settings->currency; ?> <?php 
                                         $pharmacy_payment = $this->pharmacy_model->getPaymentByInvoiceId($payment->id);

                                         if(!empty($pharmacy_payment->invoice_id)){
                                        echo $payment->gross_total + $pharmacy_payment->gross_total;}
                                            else {echo $payment->gross_total;} ?>
                                        ...
                                        <td><?php
                                            ...
                                            if(!empty($pharmacy_payment->invoice_id) && $pharmacy_payment->status == 'paid'){

                                            ?> <?php echo $payment->amount_received + $pharmacy_payment->gross_total; }
                                                else{ echo $payment->amount_received; }

                                            ?>
                                        </td>

                                        <td> <?php echo $payment->deposit_type; ?></td>
                                        <td> <?php echo $payment->insurance_number; ?></td>
                                            ...
                                            if (!empty($payment->category_name)) {
                                                ...
                                                foreach ($category_name1 as $category_name2) {
                                                    ...
                                                    $category_name3 = explode('*', $category_name2);
                                                        ...
                                                        ?>  
                                       <!--  <td><?php echo $this->finance_model->getPaymentcategoryById($category_name3[0])->category; ?> </td><?php }}?>
 -->
                                        <td  class="no-print"> 
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist'))) { ?>
                                                <a class="btn btn-info width_auto" title="<?php echo lang('edit'); ?>" style="width: 90%;" href="finance/editPayment?id=<?php echo $payment->id; ?>"><i class="fa fa-edit"> </i></a>
                                            <?php } ?>
                                            <a class="btn invoicebutton width_auto" title="<?php echo lang('invoice'); ?>" style="color: #fff; width: 90%;" href="finance/invoice?id=<?php echo $payment->id; ?>"><i class="fa fa-file-text"></i> </a>
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist'))) { ?> 
                                                <a class="btn btn-info delete_button width_auto" title="<?php echo lang('delete'); ?>" style="width: 90%;"  href="finance/delete?id=<?php echo $payment->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i> </a>

                                                 <a class="btn btn-primary width_auto" title="<?php echo 'Prescription'; ?>" style="width: 90%;" href="finance/pharmacy/addPaymentView?id=<?php echo $patient->id; ?>&inv=<?php echo $payment->id;?>"><i class="fa fa-plus-circle"> </i></a>
        ...
        <section class="no-print col-md-4">
            ...
            <div class="">
                <section class="m_t">
                    <div class="panel-body profile">
                        <div class="task-thumb-details">
                            ...
                            <?php echo lang('protocal_number'); ?>: <p> <?php echo $patient->id; ?></p> <br />
                ...
                foreach ($pharmacy_payments as $ppayment) {
                    $total_bill[] = $ppayment->gross_total;
                }

                // var_dump($pharmacy_payments);
                if (!empty($total_bill)) {
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <div class="degree">
                                        ...
                                        foreach ($pharmacy_payments as $ppayments) {
                                            if($ppayments->status == 'paid'){
                                            $total_deposit[] = $ppayments->gross_total;}
                                        }
