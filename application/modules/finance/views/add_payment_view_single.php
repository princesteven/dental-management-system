                                ...
                                <div class="">
                                    ...
                                    <form role="form" id="editPaymentForm" class="clearfix" action="finance/addPayment" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-5 row">
                                            ...
                                            <div class="col-md-8 payment pad_bot">
                                                <div class="col-md-3 payment_label"> 
                                                    <label for="date_input"><?php echo lang('date'); ?> </label>
                                                </div>
                                                <div class="col-md-9"> 
                                                    <input type="text" class="form-control  default-date-picker" name="date" id="date_input" value='<?php
                                            ...
                                            <div class="col-md-12 payment pad_bot panel">
                                                <label for="patient_name"><?php echo lang('patient'); ?> <?php echo lang('name'); ?></label>
                                                <h4>  <?php echo $patient->name; ?></h4>
                                                 <label for="patient_id"><?php echo lang('patient'); ?> <?php echo lang('id'); ?></label>
                                            ...
                                            <div class="pos_client">
                                                <div class="col-md-6 payment pad_bot">
                                                    <label> <?php echo lang('patient'); ?> <?php echo lang('name'); ?></label>
                                            ...
                                            <div class="col-md-12 payment pad_bot">
                                                <label for="add_doctor"> <?php echo lang('refd_by_doctor'); ?></label>
                                            ...
                                            <div class="pos_doctor">
                                                <div class="col-md-6 payment pad_bot">
                                                    <label for="d_name"> <?php echo lang('doctor'); ?> <?php echo lang('name'); ?></label>
                                                ...
                                                <div class="col-md-6 payment pad_bot">
                                                    <label for="d_email"> <?php echo lang('doctor'); ?> <?php echo lang('email'); ?></label>
                                                ...
                                                <div class="col-md-6 payment pad_bot"> 
                                                    <label for="d_phone"> <?php echo lang('doctor'); ?> <?php echo lang('phone'); ?></label>
                                            ...
                                            <div class="col-md-12 payment">
                                                <div class="form-group last"> 
                                                    <label for="my_multi_select3"> <?php echo lang('select'); ?></label>
                                                    <select name="category_name[]" id="" class="multi-select" multiple="" id="my_multi_select3" >
                                                        <?php foreach ($categories as $category) { ?>
                                                            <option class="ooppttiioonn" data-id="<?php echo $category->c_price; ?>" data-idd="<?php echo $category->id; ?>" data-cat_name="<?php echo $category->category; ?>" 

                                                               data-cat_name2="<?php echo $category->description; ?>" value="<?php echo $category->category; ?>" 
                                                                    ...
                                                                    ?>><?php echo $category->category."-".$category->description; ?></option>
                                                                <?php } ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="col-md-12 payment right-six">
                                                <div class="payment_label"> 
                                                    <label for="subtotal"><?php echo lang('sub_total'); ?> </label>
                                                </div>
                                                <div class=""> 
                                            ...
                                            <div class="col-md-12 payment right-six">
                                                <div class="payment_label"> 
                                                    <label for="dis_id"><?php echo lang('discount'); ?>  <?php
                                            ...
                                            <div class="col-md-12 payment right-six">
                                                <div class="payment_label"> 
                                                    <label for="gross"><?php echo lang('gross_total'); ?> </label>
                                                </div>
                                                <div class=""> 
                                            ...
                                            <div class="col-md-12 payment right-six">
                                                ...
                                                <div class=""> 
                                                    <input type="text" class="form-control pay_in" name="remarks" id="note" value='<?php
                                            ...
                                            <div class="col-md-12 payment right-six">
                                                ...
                                                <div class="col-md-12 payment right-six">
                                                    <div class="payment_label"> 
                                                        <label for="is_patient_new"><?php echo 'Is New Patient?'; ?></label>
                                                    </div>
                                                    <div class=""> 
                                                        <select class="form-control m-bot15 js-example-basic-single selecttype" id="is_patient_new" required="" name="is_new_patient" value=''> 
                                                                <?php if(!empty($payment->is_new_patient)){ ?>
                                                                 <option value="<?php echo $payment->is_new_patient; ?>"> <?php echo $payment->is_new_patient; ?> </option><?php }?>   
                                            ...
                                            <?php if (empty($payment->id)) { ?>
                                                <div class="col-md-12 payment right-six">
                                                    <div class="payment_label"> 
                                                        <label for="deposit_type"><?php echo lang('deposit_type'); ?></label>
                                                    </div>
                                                    <div class=""> 
                                                        <select class="form-control m-bot15 js-example-basic-single selecttype" id="deposit_type" name="deposit_type" value=''> 
                                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist'))) { ?>
                                                                <option value="Cash"> <?php echo lang('cash'); ?> </option>
                                                                <!-- <option value="M-Pesa"> <?php echo lang('m_Pesa'); ?> </option>
                                                                <option value="Tigo-Pesa"> <?php echo lang('tigo_Pesa'); ?> </option>
                                                                <option value="T-Pesa"> <?php echo lang('t_Pesa'); ?> </option>
                                                                <option value="Halo-Pesa"> <?php echo lang('halo_Pesa'); ?> </option>
                                                                <option value="Airtel-Money"> <?php echo lang('airtel_Money'); ?> </option> -->
                                                    ...
                                                    <div class="insurance">
                                                        <div class="col-md-12 payment pad_bot">
                                                            <label for="insurance_type"> <?php echo lang('insurance'); ?> <?php echo lang('type'); ?></label>
                                                            <select class="form-control m-bot15" name="insurance_type">
                                                                <option value=""> <?php echo lang('select'); ?> <?php echo lang('insurance'); ?></option>   
                                                                <option value="Jubilee"> <?php echo lang('jubilee'); ?> </option>   
                                                                <option value="NHIF"> <?php echo lang('nhif'); ?> </option>
                                                            </select>
                                                        </div>

                                                        <div class="col-md-12 payment pad_bot">
                                                            <label for="insurance_number"> <?php echo lang('insurance'); ?> <?php echo lang('number'); ?></label>
                                                            <input type="text" class="form-control pay_in" name="insurance_number">
                                                        </div>
                                                    </div>
                                                    ...
                                                    if ($payment_gateway == 'PayPal') {
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <hr>
                                                            <div class="col-md-12 payment pad_bot">
                                                                <label for="cards"> <?php echo lang('accepted'); ?> <?php echo lang('cards'); ?></label>
                                                            ...
                                                            <div class="col-md-12 payment pad_bot">
                                                                <label for="card_type"> <?php echo lang('card'); ?> <?php echo lang('type'); ?></label>
                                                            ...
                                                            <div class="col-md-12 payment pad_bot">
                                                                <label for="card_number"> <?php echo lang('card'); ?> <?php echo lang('number'); ?></label>
                                                            ...
                                                            <div class="col-md-8 payment pad_bot">
                                                                <label for="payment_date"> <?php echo lang('expire'); ?> <?php echo lang('date'); ?></label>
                                                            ...
                                                            <div class="col-md-4 payment pad_bot">
                                                                <label for="cvv_number"> <?php echo lang('cvv'); ?> </label>
                                            ...
                                            if (!empty($payment)) {
                                                ...
                                                foreach ($deposits as $deposit) {
                                                    ...
                                                    if (empty($deposit->amount_received_id)) {
                                                        ...
                                                        <div class="col-md-12 payment right-six">
                                                            <div class="payment_label"> 
                                                                <label for="deposit_date"><?php echo lang('deposit'); ?> <?php
                                                                    echo $i . '<br>';
                                        ...
                                        <div class="col-md-12 payment">
                                            ...
                                            <div class="col-md-9"> 
                                              <input type="text" class="form-control pay_in" name="vat" id="vat" value='<?php
        ...
        $.each($('select.multi-select option:selected'), function () {
            ...
            if ($('#idinput-' + idd).length)
            {
                ...
                if ($('#id-div' + idd).length)
                {
                    ...
                    $("#editPaymentForm .qfloww").append('<div class="remove1" id="id-div' + idd + '">  ' + $(this).data("cat_name") + $(this).data("cat_name2")+ '- <?php echo $settings->currency; ?> ' + $(this).data('id') + '</div>')
                }
...
<script>
    $(document).ready(function () {
        $('.card').hide();
        $('.insurance').hide();
        $(document.body).on('change', '#deposit_type', function () {
