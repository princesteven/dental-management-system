...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    <head>
        ...
        <link rel="shortcut icon" href="uploads/logo_330x200.jpg">
            ...
            <header class="header white-bg">
                ...
                <div class="top-nav ">
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <img alt="" src="uploads/logo_330x200.jpg" width="21" height="23">
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Nurse', 'Doctor', 'Laboratorist', 'Receptionist'))) { ?>
                            <?php if (in_array('patient', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    ...
                                    <ul class="sub"> 
                                        <?php if ($this->ion_auth->in_group(array('admin', 'Receptionist', 'Nurse'))) { ?>
                        ...
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <?php } ?>
                                        <li><a href="settings/suppliers"><i class="fa fa-user"></i><?php echo 'Suppliers'; ?></a></li>
                           ...
                           <?php if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Nurse', 'Receptionist'))) { ?>
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                        ...
                                        <li><a href="lab"><i class="fa fa-medkit"></i><?php echo 'Technician'; ?> <?php echo lang('report'); ?></a></li>
                                  
                                   
                                        <li><a href="lab/template"><i class="fa fa-edit"></i><?php echo lang('template'); ?></a></li>
                        ...
                        if ($this->ion_auth->in_group(array('Receptionist'))) {
                            ...
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li>
                                    <a href="lab/lab1">
                                        <i class="fa fa-medkit"></i>
                                        <span><?php echo 'Technician Reports'; ?></span>
                                    </a>
                                </li>
                            <?php } ?>
                            <?php
                            ...
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="settings"><i class="fa fa-gear"></i><?php echo lang('system_settings'); ?></a></li>
                                     <li><a href="settings/locations"><i class="fa fa-location-arrow"></i><?php echo 'Locations'; ?></a></li>
